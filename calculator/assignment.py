...
button_equal=Button(cal, text="=",padx=39,pady=20, fg="black", bg="yellow",command=button_equal)
button_clear=Button(cal, text="clear",padx=100,pady=20,fg="black", bg="yellow", command=button_clear)
